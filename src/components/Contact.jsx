          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px]">
                <h1 className="mb-4 text-blue-500 text-3xl block font-semibold">
                  Contact Us
                </h1>
                <h2 className="mb-6 text-[32px] font-bold uppercase text-dark dark:text-white sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="mb-9 text-gray-200 text-base leading-relaxed text-body-color dark:text-dark-6">
                ...
                <div className="flex mb-8  w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-blue-500 text-body-color dark:text-dark-6">
                      maurya1985anurag@gmial.com
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form method="POST" action="https://getform.io/f/95a757b5-53ec-4c8a-898b-332f059c2b0d">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-primary p-3 text-blue-800 transition hover:bg-blue-500 hover:text-gray-800"
                    >
                      Send Message
                    </button>
                  </div>
