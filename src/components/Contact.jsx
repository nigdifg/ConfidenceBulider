    ...
    <div className="container px-6 py-10 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-10">
            <div className="lg:w-1/2 lg:mx-10">
                ...
                <form method='POST' action='https://getform.io/f/95a757b5-53ec-4c8a-898b-332f059c2b0d' className="mt-12">
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                <img className="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96" src={anurg} alt="anu"/>
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">maurya1985anurag@gmail.com</span>
                    </p>
                </div>
                ...
                <div className="mt-6 w-80 md:mt-8">
                    ...
                    <div className="flex mt-4 -mx-1.5 ">
                        <a className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" href="https://www.linkedin.com/in/anurag-91a137203/">
