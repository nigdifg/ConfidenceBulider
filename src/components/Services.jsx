...
function Services() {
  ...
  return (
    ...
    <div className="pt-10 relative z-10 bg-gray-800">
          ...
          <div className="w-full lg:w-1/2">
            <div className="lg:max-w-xl">
              <div className="mb-6 lg:mb-16">
                <h6
                  className="text-2xl text-center font-medium text-blue-600 mb-2 lg:text-left"
                >
                  Frequently Asked Questions
                </h6>
                <h2
                  className="text-4xl text-center font-bold text-gray-300 leading-[3.25rem] mb-5 lg:text-left"
                >
                  Looking for answers?
                </h2>
              </div>
              <div className="accordion-group" data-accordion="default-accordion">
                ...
                >
                  <button
                    className="accordion-toggle group inline-flex items-center justify-between text-xl font-normal leading-8 text-blue-600 w-full transition duration-500 hover:text-blue-600 accordion-active:text-indigo-600 accordion-active:font-medium always-open"
                    aria-controls="basic-collapse-one-with-arrow-always-open"
                  >
                    <h5 >How to Book Slot?</h5>
                    <svg
                      className="text-gray-900 transition duration-500 group-hover:text-blue-600 accordion-active:text-indigo-600 accordion-active:rotate-180"
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
                      fill="none"
                  ...
                  >
                    <p className="text-base font-normal text-gray-300 ">
                      To book a slot, you can visit our website and click on the
                      "Book Slot" button.
                    </p>
                  </div>
                </div>
                ...
                >
                  <button
                    className="accordion-toggle group inline-flex items-center justify-between font-normal text-xl leading-8 text-blue-600 w-full transition duration-500 hover:text-blue-600 accordion-active:text-indigo-600 accordion-active:font-medium"
                  ...
                  >
                    <p className="text-base text-gray-300 font-normal">
                      Our focus on providing robust and user-friendly content
                       apabilities ensures that you can prepare for your
                      interview with confidence, and achieve your dream job.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  <button
                    className="accordion-toggle group inline-flex items-center justify-between text-xl font-normal leading-8 text-blue-600 w-full transition duration-500 hover:text-indigo-600 accordion-active:font-medium accordion-active:text-indigo-600"
                  ...
                  >
                    <p className="text-base text-gray-300 font-normal">
                      Our focus is on providing best services at affordable
                      prices. We have different plans for different services and
                      you can choose according to your need.
                      But we assure you that you will get the best services at
                      affordable prices.
                    </p>
                  </div>
                </div>
